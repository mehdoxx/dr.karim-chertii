...
export const AnimatedThemeToggle = ({ className }: { className?: string }) => {
    ...
    if (!mounted) {
        return <Button variant="outline" size="icon" className={cn("rounded-full", className)} />;
    }
    ...
    return (
        <Button
            ...
            className={cn("px-2.5 rounded-full", className)}
            variant="outline"
            size="icon"
        >
...
const SolarSwitch = ({ isDark }: { isDark: boolean }) => {
    ...
    return (
        <motion.div animate={isDark ? "checked" : "unchecked"} className="flex justify-center items-center">
            <motion.svg
                width="20"
                height="20"
                viewBox="0 0 25 25"
