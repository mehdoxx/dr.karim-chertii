                    ...
                    {credentials.map((cred, idx) => {
                        ...
                        return (
                            <motion.div
                                ...
                                className={`group relative rounded-2xl border ${cred.borderColor} bg-[var(--color-surface)]/50 backdrop-blur-sm p-6 md:p-8 lg:p-10 transition-all duration-500 hover:shadow-2xl ${cred.glowColor} hover:border-[#4f93cb]/40 overflow-hidden`}
                            >
